...
public:
	...
	/// <returns></returns>
	static Arrow makeBasicArrow(sf::Vector2f start, sf::Vector2f end) {
...
private:
	...
	Arrow(sf::Vector2f start = sf::Vector2f(0, 0), sf::Vector2f end = sf::Vector2f(0,0), sf::Color color = sf::Color(255, 255,0, 195),
